...
export const translation: ResourceLanguage = {
  ...
  'Are you sure to proceed?\nThe deleted history item cannot be restored.\nThe ROM related to this history item will NOT be deleted.':
    '계속하시겠습니까?\n삭제된 기록 항목은 복원할 수 없습니다.\n이 기록 항목과 연결된 ROM은 삭제되지 않습니다.',
  ...
  platform_arcade_note:
    '1971년 스페이스워!(Spacewar!)를 시작으로, 비디오 게임의 가장 초기 형태는 아케이드 게임이었습니다. 전통적인 조이스틱과 버튼 구성부터 독특한 화면, 컨트롤 및 캐비닛을 갖춘 전용 특수 캐비닛까지 다양한 형태의 아케이드 머신이 존재했습니다.',
  platform_atari2600_note:
    'Atari Video Computer System(VCS), 나중에 Atari 2600으로 명명된 이 게임기는 Atari사가 개발하고 배포한 2세대(1976-1992) 가정용 비디오 게임 콘솔입니다. 1977년 9월 11일 북미에서 소매가 199달러로 출시되었습니다. 이 콘솔은 나중에 유럽(1978년) 및 일본(1983년 - Atari 2800으로)에서 출시되었습니다. Atari 2600은 마이크로프로세서 기반 하드웨어와 ROM 카트리지에 담긴 게임의 사용을 대중화했습니다. 이 콘솔은 1992년 1월 1일에 단종되었습니다. Atari 2600+로 재출시되었으며, 현재 Atari에서 사전 주문 가능하며 2023년 12월에 출하될 예정입니다.',
  platform_atari5200_note:
    'Atari 5200 SuperSystem, 일반적으로 Atari 5200으로 알려진 이 게임기는 Atari사가 개발하고 배포한 2세대(1976-1992) 비디오 게임 콘솔입니다. 1982년 11월 북미에서 소매가 269달러로 출시되었습니다. 북미 외 지역에서는 출시되지 않았습니다. 5200의 내부 하드웨어는 Atari의 8비트 컴퓨터와 거의 동일했지만, 360도 비센터링 조이스틱, 숫자 키패드, 시작, 일시 정지 및 리셋 버튼을 갖춘 혁신적인 컨트롤러가 함께 제공되었습니다. 이 콘솔은 1984년 5월 21일에 단종되었습니다.',
  platform_atari7800_note:
    'Atari 7800 Pro System, 일반적으로 Atari 7800으로 알려진 이 게임기는 Atari Corporation이 개발하고 배포한 3세대(1983-2003) 비디오 게임 콘솔입니다. 1986년 5월 북미에서 소매가 79.95달러로 출시되었습니다. 이 콘솔은 나중에 유럽(1987년)에서 출시되었습니다. 7800은 추가 모듈을 사용하지 않고 Atari 2600 게임을 플레이할 수 있는 최초의 하위 호환 콘솔 중 하나로 간주됩니다. 이 콘솔은 1992년 1월 1일에 단종되었습니다.',
  platform_atarilynx_note:
    'Atari Lynx, 일반적으로 Lynx로 불리는 이 게임기는 Epyx사와 공동 개발하고 Atari Corporation이 배포한 4세대(1987-2004) 휴대용 비디오 게임 콘솔입니다. 1989년 9월 북미에서 소매가 149.95달러로 출시되었습니다. 이 휴대용 게임기는 유럽(1990년) 및 일본(1990년)에서도 출시되었습니다. Lynx는 컬러 LCD 화면을 탑재한 세계 최초의 휴대용 전자 게임이었습니다. 이 콘솔은 1996년 초, 아마도 1996년 4월 8일 회사 매각 시점에 단종되었습니다.',
  ...
  platform_gameandwatch_note:
    'Game & Watch 시리즈는 닌텐도가 1980년부터 1991년까지 생산한 총 60개의 휴대용 전자 게임입니다. 게임 디자이너 요코이 군페이가 제작했으며, 각 Game & Watch는 시계, 알람 또는 둘 다에 더해 LCD 화면에서 단일 게임을 플레이할 수 있는 기능을 제공합니다. 이 콘솔은 닌텐도가 Game Boy를 만들도록 영감을 주었습니다. 이것은 닌텐도 제품 중 처음으로 큰 성공을 거둔 제품이었습니다.',
  platform_gamegear_note:
    'Game Gear는 닌텐도의 Game Boy에 대응하여 세가가 제작한 휴대용 비디오 게임 콘솔입니다. Atari Lynx와 Turbo Express 다음으로 역사상 세 번째 컬러 화면 휴대용 콘솔입니다.\n이 프로젝트는 1989년 "프로젝트 머큐리"라는 이름으로 시작되어 1990년 10월 6일 일본에서 출시되었습니다. 미국과 유럽에서는 1991년에, 호주에서는 1992년에 출시되었습니다. 이 시스템에 대한 지원은 1997년 초에 중단되었습니다.',
  platform_gb_note:
    'Game Boy는 닌텐도가 개발하고 제조한 8비트 휴대용 비디오 게임 콘솔입니다. 1989년 4월 21일 일본에서, 1989년 8월 북미에서, 1990년 유럽에서 출시되었습니다. 남아시아에서는 "Tata Game Boy"로 알려져 있습니다. Game Boy 라인의 첫 번째 휴대용 콘솔입니다. 요코이 군페이와 닌텐도의 연구 개발 부서가 제작했습니다 - Game & Watch 시리즈와 NES의 여러 인기 게임을 디자인한 것과 동일한 직원들입니다. Game Boy는 1980년에 도입된 Game & Watch 시리즈에 이은 닌텐도의 두 번째 휴대용 시스템이며, Nintendo Entertainment System과 Game & Watch의 기능을 결합했습니다. 또한 Milton Bradley의 Microvision 휴대용 콘솔 이후 비디오 게임 카트리지를 사용한 최초의 휴대용 게임이기도 합니다. 원래 퍼즐 게임 테트리스와 함께 번들로 제공되었습니다. 수명 동안 도입된 다른 많은 기술적으로 우수한 휴대용 콘솔에도 불구하고 Game Boy는 엄청난 성공을 거두었습니다. Game Boy와 Game Boy Color를 합쳐 전 세계적으로 1억 1,869만 대가 판매되었습니다. 미국에서 출시되었을 때, 몇 주 만에 100만 대의 전체 출하량을 판매했습니다.',
  platform_gba_note:
  ...
  platform_ngp_note:
    'Neo Geo Pocket은 SNK가 출시한 흑백 휴대용 게임 콘솔입니다. 회사 최초의 휴대용 시스템이며 Neo Geo 제품군의 일부입니다. 1998년 말 일본에서 데뷔했지만 서양에서는 출시되지 않았으며, 일본과 홍콩과 같은 소규모 아시아 시장에만 독점되었습니다. Neo Geo Pocket은 실패한 콘솔로 간주됩니다. 예상보다 낮은 판매량으로 1999년에 단종되었으며, 즉시 Neo Geo Pocket Color로 대체되었습니다. 이는 지배적인 Game Boy Color 휴대용 기기와 더 쉽게 경쟁할 수 있는 풀 컬러 장치였으며, 서양에서도 출시되었습니다. 시스템은 짧은 수명을 누렸지만, 시스템에는 사무라이 쇼다운 및 킹 오브 파이터즈 R-1과 같은 중요한 게임이 일부 출시되었습니다.',
  platform_ngpc_note:
    'Neo Geo Pocket Color(NEOGEOPOCKET COLOR로 스타일화되기도 하며, 종종 NGPC로 약칭)는 SNK가 제조한 16비트 컬러 휴대용 비디오 게임 콘솔입니다. 1998년 일본에서 데뷔한 SNK의 흑백 Neo Geo Pocket 휴대용 기기의 후속 제품으로, Color는 완전한 하위 호환성을 갖추고 있습니다. Neo Geo Pocket Color는 1999년 3월 16일 일본에서, 1999년 8월 6일 북미에서, 1999년 10월 1일 유럽에서 출시되어 모두 닌텐도가 지배하는 시장에 진입했습니다. 14개의 런치 타이틀(당시 기록)로 미국과 일본 모두에서 좋은 판매 시작을 보였지만, 이후 미국에서의 낮은 소매 지원, SNK의 미국 경영진이 제3자 개발자와의 소통 부족, 닌텐도의 포켓몬 프랜차이즈에 대한 열광, 32비트 Game Boy Advance에 대한 기대, 일본에서 Bandai의 WonderSwan과의 강력한 경쟁으로 인해 양 지역에서 판매가 감소했습니다. 한편, SNK는 최소 1년 동안 재정 문제에 시달렸습니다. 회사는 곧 무너졌고, 2000년 1월 미국 파칭코 제조업체 Aruze에 인수되었습니다. 그러나 Aruze는 SNK의 비디오 게임 사업을 충분히 지원하지 않았고, SNK의 원래 설립자와 여러 직원이 떠나 새 회사 BrezzaSoft를 설립했습니다. 결국 2000년 6월 13일, Aruze는 북미 및 유럽 시장에서 철수하기로 결정했으며, 이는 SNK의 전 세계 운영 종료와 그곳에서 Neo Geo 하드웨어 및 소프트웨어의 단종을 의미했습니다. 그러나 Neo Geo Pocket Color(및 기타 SNK/Neo Geo 제품)는 일본에서 2001년까지 지속되었습니다. 2001년 10월 22일 파산한 SNK의 마지막 비디오 게임 콘솔이었습니다. 실패에도 불구하고 Neo Geo Pocket Color는 영향력 있는 시스템으로 간주되었습니다. SNK vs. Capcom: The Match of the Millennium, 킹 오브 파이터즈 R-2 및 SNK의 MVS 및 AES에서 파생된 기타 고품질 아케이드 타이틀과 같은 많은 호평을 받은 게임이 시스템용으로 출시되었습니다. 또한 정확성과 격투 게임에 적합하다고 칭찬받은 아케이드 스타일의 마이크로 스위치 "클리키 스틱" 조이스틱도 탑재했습니다. 시스템의 디스플레이와 40시간 배터리 수명도 호평을 받았습니다.',
  platform_odyssey2_note:
    'Magnavox Odyssey 2는 Magnavox가 개발하고 배포한 2세대(1976-1992) 가정용 비디오 게임 콘솔입니다. 1979년 2월 북미에서 소매가 179달러로 출시되었습니다. 이 콘솔은 유럽(1979년), 나중에 남미(1983년) 및 일본(1982년)에서도 출시되었습니다. Odyssey 2에는 교육 게임, 옵션 선택 또는 프로그래밍에 사용되는 완전한 영숫자 멤브레인 키보드가 포함되어 있었습니다. 이 콘솔은 1984년 3월 20일에 단종되었습니다.',
  platform_other: '플랫폼',
  ...
  platform_sms_note:
    'Master System(SMS로 약칭)은 세가가 1985년 일본(Sega Mark III로), 1986년 북미 및 1987년 유럽에서 제조하고 출시한 3세대 비디오 게임 콘솔입니다. 원래 SMS는 카트리지와 신용 카드 크기의 "세가 카드"를 모두 재생할 수 있었으며, 후자는 카트리지보다 저렴한 가격으로 소매되었지만 코드가 적었습니다. SMS에는 라이트 건과 3D 안경과 같은 액세서리도 있었으며, 특별히 코딩된 일련의 게임과 함께 작동하도록 설계되었습니다. Master System은 3세대 비디오 게임에서 Nintendo Entertainment System의 직접적인 경쟁 제품으로 출시되었습니다. SMS는 출시가 훨씬 빨랐던 NES보다 기술적으로 우수했지만, 일본과 북미에서 닌텐도의 상당한 시장 점유율 우위를 뒤집지 못했습니다.',
  platform_snes_note:
  ...
  platform_vb_note:
    'Virtual Boy는 닌텐도가 개발하고 제조한 32비트 탁상용 비디오 게임 콘솔입니다. 1995년에 출시되었으며, 입체 3D를 표시할 수 있는 최초의 콘솔로 마케팅되었습니다. 플레이어는 헤드 마운트 디스플레이와 유사한 방식으로 콘솔을 사용하여 머리를 아이피스에 대고 빨간색 흑백 디스플레이를 봅니다. 게임은 시차 효과를 사용하여 깊이의 착각을 만듭니다. 판매는 목표를 달성하지 못했으며, 1996년 초까지 닌텐도는 126만 대를 출하하고 22개의 게임을 출시한 후 배포 및 게임 개발을 중단했습니다. Virtual Boy의 개발은 4년이 걸렸으며, 원래 VR32라는 프로젝트 이름으로 시작되었습니다. 닌텐도는 미국 기반 회사 Reflection Technology가 원래 개발한 3D LED 아이피스 기술을 활용하기 위해 라이선스 계약을 체결했습니다. 또한 Virtual Boy 제조 전용으로 사용할 공장을 중국에 건설했습니다. 개발 과정에서 높은 비용과 잠재적인 건강 문제로 인해 콘솔 기술이 축소되었습니다. 또한 점점 더 많은 회사 자원이 Nintendo 64 개발에 재할당되고 있었습니다. 닌텐도의 수석 게임 디자이너 미야모토 시게루는 Virtual Boy 소프트웨어에 거의 관여하지 않았습니다. 콘솔은 Nintendo 64 개발에 집중하기 위해 1995년에 미완성 상태로 시장에 출시되었습니다. Virtual Boy는 비평가들로부터 혹평을 받았으며 상업적 실패였습니다. 그 실패는 높은 가격, 흑백 디스플레이, 인상적이지 않은 3D 효과, 진정한 휴대성 부족, 건강 문제 및 낮은 품질의 게임 때문이라고 인용되었습니다. 부정적인 평가는 지속적인 가격 인하에도 영향을 받지 않았습니다. 비디오 게임 콘솔의 3D 기술은 닌텐도 자체의 3DS 휴대용 콘솔을 포함하여 후년에 더 많은 성공을 거두며 재등장했습니다. Virtual Boy는 64DD 다음으로 닌텐도에서 두 번째로 낮은 판매 플랫폼입니다.',
  platform_videopac_note:
    'Videopac은 Philips가 1978년에 마케팅한 게임 콘솔입니다. 이것은 미국 Magnavox가 생산한 Magnavox Odyssey² 콘솔의 유럽 버전이었으며, 이와 마찬가지로 새로 출시된 Fairchild Channel F 및 Atari 2600 카트리지 콘솔에 대응해야 했습니다. 유럽에서는 Radiola JET 25, Schneider G7000, Siera G7000(모두 Philips 회사) 및 Philips C52(프랑스 시장 전용 버전)로도 마케팅되었습니다. 브라질에서는 Philips Odissey로 판매되었습니다.',
  ...
  Retry: '재시도',
  review_dash:
    'RetroAssembly는 또 하나의 에뮬레이터 프런트엔드나 ROM 관리 도구가 아니라, 장애물만 치우면 레트로 게임이 얼마나 단순하고 즐거울 수 있는지를 다시 떠올리게 해 주는 서비스입니다. 핵심은 클래식 게임들을 언제 어디서나 쉽게 찾고, 쉽게 실행하고, 손쉽게 가지고 다닐 수 있게 만드는 데 있습니다. 내부의 기술은 최신이지만, 철학은 순도 100%의 8비트 감성입니다. 게임을 고르고, 스타트 버튼을 누르면, 그 순간 바로 모험이 시작됩니다.',
  review_jim_gray:
    '손 안에 방대한 레트로 게임 라이브러리를 갖고 있는 것만으로는 충분하지 않습니다. 정작 휴대용 게임기를 집에 두고 왔다면 아무 소용이 없으니까요. 이달의 추천 게임을 시작해 보려고 할 때, 이런저런 이유로 그 게임이 기기 안에 없다는 사실을 깨닫게 될 수도 있습니다. RetroAssembly는 바로 이런 상황을 해결하고자 합니다. 여러분의 전체 컬렉션을 브라우저 하나로 언제든지 불러올 수 있게 해 주죠.',
  review_korben:
    'RetroAssembly는 브라우저 탭 안에 쏙 들어가는 개인용 레트로 게임 스테이션입니다. 설치도 필요 없고, 복잡한 설정도 없습니다. 그저 여러분의 레트로 게임 컬렉션을 어떤 기기에서든 바로 즐길 수 있을 뿐입니다. 이 플랫폼을 잠깐만 써 보면, 마치 어린 시절 게임하던 내 방을 다시 찾은 듯한 기분이 들 겁니다….',
  review_robert_triggs:
    'RetroAssembly 덕분에 게임 라이브러리 관리는 더 이상 귀찮은 일이 아니라 즐거운 일이 되었습니다. 설정은 간단하고, 사용은 매우 직관적이며, 제 모든 기기에서 잘 동작합니다. 이제는 이리저리 만지작거리는 시간을 줄이고, 실제로 게임을 하는 데 더 많은 시간을 쓸 수 있게 되었습니다.',
  Reviews: '리뷰',
  Rewind: '되감기',
  ...
  'Welcome to {{title}}.': '{{title}}에 오신 것을 환영합니다.',
